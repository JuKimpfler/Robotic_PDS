...
# manchen PyQt5-Installationen nicht vollständig aufgelöst werden können
...
# In Qt5 (anders als Qt6) muss High-DPI-Scaling explizit aktiviert werden,
# sonst wirkt die GUI auf hochauflösenden/Touch-Displays zu klein.
# Muss ebenfalls VOR der QGuiApplication-Instanziierung gesetzt werden.
